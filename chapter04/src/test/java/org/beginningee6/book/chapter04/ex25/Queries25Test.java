...
//        assertEquals(ALL, customersNames.size());
    ...
    public void shouldExecuteSeveralDynamicQueries() throws Exception {
        ...
        query = em.createQuery("select new org.beginningee6.book.chapter04.ex25.CustomerDTO25(c.firstName, c.lastName, c.address.country) from Customer25 c where c.firstName = 'Vincent'");
        assertEquals(2, query.getResultList().size());
