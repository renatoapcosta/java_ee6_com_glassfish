package org.beginningee6.book.chapter05.ex01;
 ...
 *         --
 */
public class Customer01Test extends AbstractPersistentTest {
    ...
    public void shouldCheckTheAgeOfTheCustomer() throws Exception {
        ...
        Customer01 customer = new Customer01("John", "Smith", "jsmith@gmail.com", "1234565", new Date(), new Date());
    ...
    public void shouldThrowAnExceptionBecauseFirstNameIsNull() throws Exception {
        ...
        // Instanciates an object
        Customer01 customer = new Customer01(null, "Smith", "jsmith@gmail.com", "1234565", new Date(), new Date());
    ...
    public void shouldThrowAnExceptionBecauseLastNameIsNull() throws Exception {
        ...
        // Instanciates an object
        Customer01 customer = new Customer01("John", null, "jsmith@gmail.com", "1234565", new Date(), new Date());
