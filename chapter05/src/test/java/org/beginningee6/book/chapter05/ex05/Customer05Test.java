 ...
 *         --
 */
public class Customer05Test extends AbstractPersistentTest {
    ...
    public void shouldShowDifferentLifeCyclePhases() throws Exception {
        ...
        Customer05 customer = new Customer05("John", "Smith", "jsmith@gmail.com", "1234565");
        ...
        customer = em.find(Customer05.class, customer.getId());
