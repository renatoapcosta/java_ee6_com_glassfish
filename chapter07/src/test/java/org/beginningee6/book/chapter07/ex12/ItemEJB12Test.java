...
public class ItemEJB12Test {
    ...
    public void shouldLookUpDifferentEJBInterfaces() throws Exception {
        ...
        ItemEJB12 itemEJB = (ItemEJB12) ctx.lookup("java:global/classes/ItemEJB12!org.beginningee6.book.chapter07.ex12.ItemEJB12");
...
// KO        ItemLocal12 itemLocal = (ItemLocal12) ctx.lookup("java:global/classes/ItemEJB12!org.beginningee6.book.chapter07.ex12.ItemLocal12");
