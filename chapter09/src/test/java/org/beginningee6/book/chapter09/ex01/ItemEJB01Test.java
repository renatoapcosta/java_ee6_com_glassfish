package org.beginningee6.book.chapter09.ex01;
 ...
 *         APress Book06 - Beginning Java EE 6 with Glassfish
 *         http://www.apress.com/
...
public class ItemEJB01Test {
    ...
    public void shouldCreateABook() throws Exception {
        ...
        // Looks up the EJB
        ItemEJB01 itemEJB = (ItemEJB01) ctx.lookup("java:global/classes/ItemEJB01!org.beginningee6.book.chapter09.ex01.ItemEJB01");
    ...
    public void shouldCreateACD() throws Exception {
        ...
        assertNotNull("CD should have been found", itemEJB.findBookById(cd.getId()));
